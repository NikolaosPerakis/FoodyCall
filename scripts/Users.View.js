...
Users.prototype.initTemplates = function() {
  this.templates = {};
...
Users.prototype.viewSetup = function() {
  var headerEl = this.renderTemplate('header-base', {
...
Users.prototype.initReviewDialog = function() {
...
Users.prototype.initFilterDialog = function() {
...
Users.prototype.updateQuery = function(filters) {
...
Users.prototype.renderTemplate = function(id, data) {
...
Users.prototype.render = function(el, data) {
  if (!data) {
    return;
  }
...
Users.prototype.useModifier = function(el, selector, modifier) {
  el.querySelectorAll('[' + selector + ']').forEach(modifier);
};

Users.prototype.getDeepItem = function(obj, path) {
...
Users.prototype.renderRating = function(rating) {
...
Users.prototype.renderPrice = function(price) {
...
Users.prototype.replaceElement = function(parent, content) {
  parent.innerHTML = '';
  parent.append(content);
};

Users.prototype.rerender = function() {
